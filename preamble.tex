...
\usepackage[style=gost-r-7-0-5-2008-numeric]{citation-style-language}
...
\newcommand{\sectionbreak}{\clearpage}   % добавить
...
%% Standard algorithm float + pseudocode (used in related.tex)
\usepackage{algorithm}
\usepackage{algpseudocode}

%% Custom algorithm environment from liontiger23 template (disabled —
%% conflicts with the float-based \begin{algorithm}[H] used in content files).
...
%% fixltx2e is obsolete since LaTeX 2015 — its fixes are now in the kernel
%\usepackage{fixltx2e}
